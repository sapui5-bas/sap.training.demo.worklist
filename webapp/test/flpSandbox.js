		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Worklist App",
									"targetURL": "#saptrainingfullscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingfullscreen-display": {
								"semanticObject": "saptrainingfullscreen",
								"action": "display",
								"description": "A simple worklist app",
								"title": "Demo Worklist App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.fullscreen",
									"url": sap.ui.require.toUrl("sap/training/fullscreen")
								}
							}
						}
					}
